          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <form action="<?=site_url('admin/admin_tiket_DoEdit/'.$tampil3[0]->id_tiket);?>" method="POST" role="form" enctype="multipart/form-data">
                   ...
                   ?>
                    <option value="<?=$key->id_wisata ?>"> <?php echo $key->nama ?></option>        
                   <?php
                   } ?> 
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="kode" class="form-control" id="" value="<?php echo $tampil3[0]->kode_unik  ?>" disabled>
                  </div>      
