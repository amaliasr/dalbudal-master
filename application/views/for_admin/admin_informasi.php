                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img src="<?=base_url()?>upload/sedang/<?=$key->gambar?>" width="50" height="50">
                          </td>
                          <td>
                              <a href="<?=site_url('admin/admin_informasi_edit/').$key->id_informasi.'/'.$key->id_wisata?>"><span class="glyphicon glyphicon-edit"></span></a>
                              <a href="<?=site_url('admin/admin_informasi_delete/').$key->id_informasi.'/'.$key->gambar?>"><span class="glyphicon glyphicon-trash"></span></a>
                          </td>
                        </tr>
