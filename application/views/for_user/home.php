<?php $this->load->view('for_user/header'); ?>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(<?=base_url()?>assets/images/cover_bg_1.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
										...
										<div class="row">
											<div class="col-sm-12 mt">
												...
												<section>
													...
													<label for="class" >Tempat Wisata:</label>
													<select class="cs-select cs-skin-border">
														<option value="" disabled selected>Coban Rondo</option>
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									<h2>Jalan Jalan yuk dari sekarang</h2>
									<p>dalbudal.com</p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="<?=base_url()?>assets/images/place-1.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>New York</h3>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="<?=base_url()?>assets/images/place-2.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Philippines</h3>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="<?=base_url()?>assets/images/place-3.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Hongkong</h3>
